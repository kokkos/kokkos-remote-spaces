...
#ifndef KOKKOS_REMOTESPACES_ROCSHMEM_VIEWTRAITS_HPP
#define KOKKOS_REMOTESPACES_ROCSHMEM_VIEWTRAITS_HPP
...
struct ViewTraits<void, Kokkos::Experimental::ROCSHMEMSpace, Properties...> {
  static_assert(
  ...
  using execution_space =
      typename Kokkos::Experimental::ROCSHMEMSpace::execution_space;
  using memory_space =
      typename Kokkos::Experimental::ROCSHMEMSpace::memory_space;
  using HostMirrorSpace = typename Kokkos::Impl::HostMirror<
      Kokkos::Experimental::ROCSHMEMSpace>::Space;
...
#endif  // KOKKOS_REMOTESPACES_ROCSHMEM_VIEWTRAITS_HPP
